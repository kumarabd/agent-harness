...
-- turn_retrieval (013, key col owner_id since 021) FKs turns(turn_id), so it
-- goes before the turns rows it references. The pre-LLM retrieval fan-out and
-- the skill subsystem (skill_procedures / skill_cooccurrence / turn_plan /
-- episodes tables) were all removed over the turn-pipeline redesign — nothing
-- to clean there any more.
